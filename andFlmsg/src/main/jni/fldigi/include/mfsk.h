...
//Android #include <FL/Fl_Widget.H>
//Android #include <FL/Fl_Double_Window.H>
//Android #include <FL/Fl_Button.H>
//Android #include <FL/Fl_Shared_Image.H>
...
//Android #include "mbuffer.h"
//Android #include "picture.h"
...
extern	void	updateRxPic(int data, int pos);
...
/*Android Not yet extern void cb_picRxClose( Fl_Widget *w, void *);
...
//Android: For simplicity, made the Picture variables public
int TXspp;
...
// receive
	...
	double met1;
	double met2;
//Android	mbuffer<double, 0, 2> scopedata;
	double s2n;
	double sig;
	double noise;
	double afcmetric;
...
public:
	//Android	mfsk (trx_mode md);
	mfsk (int md);
	~mfsk ();
	void	init();
	void	rx_init();
//Android	void	tx_init(SoundBase *sc);
	void	tx_init();
	void	restart() {};
//Android	int		rx_process(const double *buf, int len);
